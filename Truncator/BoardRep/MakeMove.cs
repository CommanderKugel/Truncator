...
public unsafe partial struct Pos
{
    ...
    public void MakeMove(Move m, SearchThread thread)
    {
        ...
        thread.nodeStack[thread.ply].ContCorrHist = thread.CorrHist.ContHist[Them, movingPt, m.to];
    ...
    public void MakeNullMove(SearchThread thread)
    {
        ...
        thread.nodeStack[thread.ply].ContCorrHist = thread.CorrHist.ContHist.NullHist;
